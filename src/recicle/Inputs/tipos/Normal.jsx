...
const InputNormal = (props) => {
  ...
  return (
    <div className="flex flex-col mx-3 F h-20">
      ...
      <input
        className={`mt-1 px-3 py-2 border min-w-56 !text-base rounded-md shadow-sm sm:text-sm focus:outline-none bg-white focus:ring-indigo-500 focus:border-indigo-500 ${ancho}`}
        placeholder={label}
        name={name}
        value={value}
